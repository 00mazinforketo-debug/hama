...
export const LoginPage = () => {
  ...
  const infoHref = getExternalInfoUrl();
  ...
  return (
    <div className="app-shell relative overflow-hidden">
      ...
      <div className="app-stage relative flex flex-col gap-3 sm:gap-5">
        ...
        <div className="flex min-h-[calc(100vh-7rem)] flex-col gap-3 sm:min-h-[calc(100vh-8.5rem)] sm:gap-5 xl:grid xl:grid-cols-[minmax(0,1fr)_minmax(19rem,28rem)]">
          <section className="app-panel flex min-w-0 flex-1 items-center shadow-glow sm:p-7 xl:p-10">
          ...
          <section className="app-panel-strong w-full min-w-0 max-w-none bg-slate-950/70 sm:p-7 xl:p-8">
