...
const sortCatalogRecords = (state: Pick<DemoState, "categories" | "menuItems">) => {
...
const syncCatalogDefaults = (state: DemoState) => {
...
const loadState = () => {
  ...
  if (state) {
    ...
    syncCatalogDefaults(migratedState);
...
const getOrderActivityLast24Hours = (state: DemoState, now: Date): AdminSummary["orderActivityLast24Hours"] => {
